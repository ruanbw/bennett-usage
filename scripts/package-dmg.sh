...
#
#   version           marketing version stamped into Info.plist (default 1.4.1)
#   --only <variant>  build only this variant; repeatable and comma-separated.
#                     variants: arm64 | x86_64 | universal   (default: all three)
#
# Examples:
#   ./scripts/package-dmg.sh                      # all three DMGs, version 1.4.1
#   ./scripts/package-dmg.sh 1.4.1                # all three DMGs, version 1.4.1
#   ./scripts/package-dmg.sh 1.4.1 --only universal
#   ./scripts/package-dmg.sh 1.4.1 --only arm64,x86_64
#
# Outputs (dist/):
