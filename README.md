...
- **14 data sources** — local session logs parsed directly. No API keys, plain SQLite storage, FSEvents file watching for automatic sync.
...
./scripts/package-dmg.sh 1.3.0      # pin the version number
